...
export const STRINGS = {
  ...
  'layout.free': { en: 'Free — arrange by hand', zh: '自由排布 — 手动摆' },
  'canvas.title': { en: 'Arrange on the sheet', zh: '在纸上排布' },
  'canvas.hint': {
    en: 'Drag to move, drag the bottom-right corner to resize. Pages are placed automatically first.',
    zh: '拖动移动，拖右下角缩放。先自动铺好，再按需要挪。',
  },
  'canvas.rearrange': { en: 'Auto arrange', zh: '重新自动排' },
  'canvas.fit': { en: 'Fit selected', zh: '选中项铺满' },
  'canvas.front': { en: 'Bring to front', zh: '移到最上层' },
